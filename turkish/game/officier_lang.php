...
$lang = [
    ...
    'of_recruit' => 'Satın Al',
    'of_inactive' => 'Pasif',
    'of_darkmatter_description' => 'Karanlık madde, sadece son birkaç standart yıldır çok büyük uğraşlar sonucu depolanabilen bir maddedir. Sayesinde çok büyük miktarda enerji kazanılabilir. Bu maddeyi elde edebilmek çok zor ve riskli olduğu için çok değerli bir maddedir.Sadece satın alınmış ve mevcut olan Karanlık Madde hesabını silinmekten korur!',
    ...
    'of_time_remaining_one' => '%s kaldı',
    'of_time_remaining_many' => '%s daha aktif',
    'of_hire_commander' => 'Commander edin',
    'of_hire_admiral' => 'Amiral görevlendir',
    'of_hire_engineer' => 'Mühendis görevlendir',
    'of_hire_geologist' => 'Jeolog görevlendir',
    'of_hire_technocrat' => 'Teknokrat görevlendir',
    'of_add_premium_officier_commander' => '+40 favori, inşa listesi, imparatorluk menüsü, kısa yollar, nakliye tarayıcısı, reklamsız oyun* (*oyunlarla ilgili notlar hariç)',
    'of_add_premium_officier_admiral' => 'Maksimum filo sayısı +2, maksimum keşif sayısı +1, geliştirilmiş filo kaçış oranı',
    'of_add_premium_officier_engineer' => 'Savunmada yarı yarıya düşüş, +%10 enerji üretimi',
    'of_add_premium_officier_geologist' => '+10% maden geliri',
    'of_add_premium_officier_technocrat' => '+2 casusluk seviyesi, %25 daha az araştırma süresi',
    'officiers' => [
        601 => [
            'name' => 'Commander',
