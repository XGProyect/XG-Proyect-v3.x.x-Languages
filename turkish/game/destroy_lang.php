<?php
$lang = [
    'des_report_title' => 'Ay saldırısı', // ok
    'des_report_start' => '%s %s filoların %s %s gezegenin ayına ulaşıyor.', // ok
    'des_report_defender' => 'The defender has failed to stop the destruction of the moon.',
    'des_result_none' => 'Ayin yapisi gerektiğince zayıflatılmamış. Filon vatana geri dönüyor.', // ok
    ...
    'des_moon_ds_chances' => 'Ayı yok etme şansın: %d %%, ÖY yok olma şansı: %d %%', // ok
];
